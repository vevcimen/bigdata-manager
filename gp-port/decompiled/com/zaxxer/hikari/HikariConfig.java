...
implements HikariConfigMXBean {
    ...
    public void setMetricRegistry(Object metricRegistry) {
        ...
        if (metricRegistry != null && !(metricRegistry = this.getObjectOrPerformJndiLookup(metricRegistry)).getClass().getName().contains("MetricRegistry") && !metricRegistry.getClass().getName().contains("MeterRegistry")) {
