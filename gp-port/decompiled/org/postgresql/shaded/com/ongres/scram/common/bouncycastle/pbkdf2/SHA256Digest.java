...
implements EncodableDigest {
    ...
    protected void processBlock() {
        ...
        int t = 0;
        for (i = 0; i < 8; ++i) {
            d += (h2 += this.Sum1(e) + this.Ch(e, f, g2) + K[t] + this.X[t]);
            h2 += this.Sum0(a) + this.Maj(a, b, c);
            c += (g2 += this.Sum1(d) + this.Ch(d, e, f) + K[++t] + this.X[t]);
            g2 += this.Sum0(h2) + this.Maj(h2, a, b);
            b += (f += this.Sum1(c) + this.Ch(c, d, e) + K[++t] + this.X[t]);
            f += this.Sum0(g2) + this.Maj(g2, h2, a);
            a += (e += this.Sum1(b) + this.Ch(b, c, d) + K[++t] + this.X[t]);
            e += this.Sum0(f) + this.Maj(f, g2, h2);
            h2 += (d += this.Sum1(a) + this.Ch(a, b, c) + K[++t] + this.X[t]);
            d += this.Sum0(e) + this.Maj(e, f, g2);
            g2 += (c += this.Sum1(h2) + this.Ch(h2, a, b) + K[++t] + this.X[t]);
            c += this.Sum0(d) + this.Maj(d, e, f);
            f += (b += this.Sum1(g2) + this.Ch(g2, h2, a) + K[++t] + this.X[t]);
            b += this.Sum0(c) + this.Maj(c, d, e);
            e += (a += this.Sum1(f) + this.Ch(f, g2, h2) + K[++t] + this.X[t]);
