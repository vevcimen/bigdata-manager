...
public class StringPrep {
    ...
    public static boolean bidirectional(List<Integer> value) throws IllegalArgumentException {
        ...
        for (int i = 0; i < value.size(); ++i) {
            ...
            if (!StringPrep.bidirectionalPropertyL(character)) continue;
